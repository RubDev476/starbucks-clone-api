...
export default function Header() {
    //On first load, the menu icon animation is activated, that's why I leave the string empty
    const [menuAction, setMenuAction] = useState<'open' | 'close' | ''>('');

    useEffect(() => {
        window.addEventListener(('resize'), () => {
            if(innerWidth >= 790) setMenuAction('');
        })
    }, [])
    ...
    useEffect(() => {
        ...
        if(menuAction === 'close' || menuAction === '') {
